...
- [ ] Confirm task does NOT require adding forbidden dependencies:
  - No Shadcn/UI, Material-UI, Chakra, or any component library
  - No Radix UI (we build our own primitives)
  - No Lucide-react or any icon library (we own our SVG icons)
